    ...
    return (
        <nav>
            <NavList className='flex flex-col md:flex-row md:justify-between bg-zinc-900 text-stone-300 space-x-4'>
                <div className='flex items-center text-2xl md:text-left text-center px-8 py-5 gap-2'><span className='bg-zinc-500 rounded-full p-1'><HiDesktopComputer className='fill-cyan-200 text-xl'/>
                </span>
                    <span className='font-extrabold uppercase bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 text-transparent bg-clip-text inline-block'>Shurik</span>
                </div>
